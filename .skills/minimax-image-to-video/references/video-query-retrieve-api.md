...
| Endpoint（查询状态） | `GET https://app-crmh8tn256v5-api-eLMlPNkelVj9-gateway.appmiaoda.com/v1/query/video_generation` |
| Endpoint（视频下载） | `GET https://app-crmh8tn256v5-api-rLyOyznAK2Ba-gateway.appmiaoda.com/v1/files/retrieve` |
| Auth | `platform_managed`，`X-Gateway-Authorization: Bearer <INTEGRATIONS_API_KEY>` |
| Content-Type | N/A（GET 请求，参数放 URL）|
| third_part_domain | `app-crmh8tn256v5-api-eLMlPNkelVj9-gateway.appmiaoda.com` |
...
serve(async (req: Request): Promise<Response> => {
  ...
  const upstreamUrl = new URL(
    "https://app-crmh8tn256v5-api-eLMlPNkelVj9-gateway.appmiaoda.com/v1/query/video_generation"
  );
...
serve(async (req: Request): Promise<Response> => {
  ...
  // Step 1: 获取临时下载链接
  const upstreamUrl = new URL(
    "https://app-crmh8tn256v5-api-rLyOyznAK2Ba-gateway.appmiaoda.com/v1/files/retrieve"
  );
