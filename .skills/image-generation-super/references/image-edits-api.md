...
| Endpoint | `POST https://app-crmh8tn256v5-api-baBw3XMNVmv9-gateway.appmiaoda.com/image2`       |
...
async function editImage(params: EditImageParams): Promise<EditImageResult> {
  ...
  const response = await fetch(
    "https://app-crmh8tn256v5-api-baBw3XMNVmv9-gateway.appmiaoda.com/image2",
    {
      method: "POST",
      headers: {
