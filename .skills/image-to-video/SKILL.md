...
| 接口 | Method | Endpoint |
|------|--------|----------|
| 创建图生视频任务 | POST | `https://app-crmh8tn256v5-api-m9xKX785MdZa-gateway.appmiaoda.com/imagetovideo` |
| 查询图生视频生成任务状态 | GET | `https://app-crmh8tn256v5-api-ra5EZDjVv8Xa-gateway.appmiaoda.com/image2video?task_id={task_id}` |
...
async function generateImageToVideo(
  ...
  const submitRes = await fetch(
    "https://app-crmh8tn256v5-api-m9xKX785MdZa-gateway.appmiaoda.com/imagetovideo",
    {
      method: "POST",
      headers: {
  ...
  while (Date.now() < deadline) {
    ...
    const queryRes = await fetch(
      `https://app-crmh8tn256v5-api-ra5EZDjVv8Xa-gateway.appmiaoda.com/image2video?task_id=${taskId}`,
      {
        method: "GET",
        headers: {
          "Content-Type": "application/json",
