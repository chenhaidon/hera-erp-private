...
| Endpoint | `POST https://app-crmh8tn256v5-api-zYkZz8qoKDdL-gateway.appmiaoda.com/rest/2.0/image-classify/v1/image-understanding/get-result` |
| 生成期 URL（含 API ID） | `https://app-crmh8tn256v5-api-zYkZz8qoKDdL-gateway.appmiaoda.com/rest/2.0/image-classify/v1/image-understanding/get-result` |
| Content-Type | `application/json` |
| Auth Header | `X-Gateway-Authorization: Bearer ${INTEGRATIONS_API_KEY}` |
| 认证模式 | `platform_managed` |
| third_part_domain | `app-crmh8tn256v5-api-zYkZz8qoKDdL-gateway.appmiaoda.com` |
| 计费 | 不启用（查询接口免费） |
...
serve(async (req: Request): Promise<Response> => {
  ...
  const upstream = await fetch(
    "https://app-crmh8tn256v5-api-zYkZz8qoKDdL-gateway.appmiaoda.com/rest/2.0/image-classify/v1/image-understanding/get-result",
    {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
