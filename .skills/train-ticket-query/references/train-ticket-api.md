...
| Endpoint | `POST https://app-crmh8tn256v5-api-DLEO73lBPZ2a-gateway.appmiaoda.com/train/ticket` |
| 认证方式 | platform_managed（密钥由平台注入） |
| Auth Header | `X-Gateway-Authorization: Bearer ${apiKey}` |
| Content-Type | `application/json;charset=UTF-8` |
| Third-party Domain | `app-crmh8tn256v5-api-DLEO73lBPZ2a-gateway.appmiaoda.com` |
...
serve(async (req: Request): Promise<Response> => {
  ...
  const upstream = await fetch(
    `https://app-crmh8tn256v5-api-DLEO73lBPZ2a-gateway.appmiaoda.com/train/ticket?${params}`,
    {
      method: "POST",
      headers: {
        "Content-Type": "application/json;charset=UTF-8",
