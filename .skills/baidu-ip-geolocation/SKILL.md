...
- **Endpoint**：`GET https://app-crmh8tn256v5-api-79jK62Ze2pQL-gateway.appmiaoda.com/location/ip`
...
serve(async (req: Request): Promise<Response> => {
  ...
  const upstreamUrl = `https://app-crmh8tn256v5-api-79jK62Ze2pQL-gateway.appmiaoda.com/location/ip${
