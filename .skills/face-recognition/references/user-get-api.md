...
| Endpoint | `POST https://app-crmh8tn256v5-api-GaDwZ0j38X6Y-gateway.appmiaoda.com/rest/2.0/face/v3/faceset/user/get` |
| Auth 模式 | `platform_managed` |
| Auth Header | `X-Gateway-Authorization: Bearer <INTEGRATIONS_API_KEY>` |
| Content-Type | `application/json` |
| third_part_domain | `app-crmh8tn256v5-api-GaDwZ0j38X6Y-gateway.appmiaoda.com` |
| 计费 | 否 |
...
serve(async (req: Request): Promise<Response> => {
  ...
  const upstream = await fetch(
    "https://app-crmh8tn256v5-api-GaDwZ0j38X6Y-gateway.appmiaoda.com/rest/2.0/face/v3/faceset/user/get",
    {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
