...
- **Endpoint**：`POST https://app-crmh8tn256v5-api-ELbWz8OmB58Y-gateway.appmiaoda.com/mobile/area`
...
serve(async (req: Request): Promise<Response> => {
  ...
  const upstreamUrl = new URL("https://app-crmh8tn256v5-api-ELbWz8OmB58Y-gateway.appmiaoda.com/mobile/area");
